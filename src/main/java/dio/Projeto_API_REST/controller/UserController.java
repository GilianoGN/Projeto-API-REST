...
import dio.Projeto_API_REST.controller.dto.UserDto;
...
public record UserController(UserService userService) {
    ...
    @GetMapping
    @Operation(summary = "Get all users", description = "Retrieve a list of all registeres users")
    ...
    public ResponseEntity<UserDto> create(@RequestBody UserDto userDto) {
        ...
        URI location = ServletUriComponentsBuilder.fromCurrentRequest()
            .path("/{id}")
            .buildAndExpand(user.getUser_Id())
            .toUri();
